                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="filter-search" placeholder="Nome, endereço, estado..." class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                            </div>

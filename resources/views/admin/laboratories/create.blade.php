...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-medium text-gray-900">Adicionar Novo Laboratório</h2>
        </div>

        <form action="{{ route('admin.laboratories.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="url" name="website" id="website" value="{{ old('website') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div class="mb-4">
                ...
                <input type="hidden" id="hidden-address-input" name="address" value="{{ old('address') }}">
                <gmpx-place-picker
                    id="address"
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" name="building" id="building" value="{{ old('building') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <input type="text" name="floor" id="floor" value="{{ old('floor') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" name="room" id="room" value="{{ old('room') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                ...
                <div>
                    ...
                    <input type="text" name="department" id="department" value="{{ old('department') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="campus" id="campus" value="{{ old('campus') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="email" name="contact_email" id="contact_email" value="{{ old('contact_email') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="working_hours" id="working_hours" value="{{ old('working_hours') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                @error('working_hours') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>

            <div class="mb-4">
                <label class="inline-flex items-center">
                    <input type="checkbox" name="has_accessibility" id="has_accessibility" value="1" {{ old('has_accessibility') ? 'checked' : '' }} class="form-checkbox h-5 w-5 text-indigo-600">
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" class="px-4 py-2 text-sm text-white bg-indigo-600 rounded-md">Criar</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    async function initMapAndPlacePicker() {
        ...
        const map = document.querySelector('#create-map');
